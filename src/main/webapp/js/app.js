...
(function($, window) {
	...
	function show(pageName, param) {
		...
		$(document.body).attr("page", pageName).find("section").fadeOut(1000)
				.removeClass("active").filter("section#" + pageName).fadeIn(
						1000).addClass("active");
		
		/*$(document.body).attr("page", pageName).find("section")
		.removeClass("active").filter("section#" + pageName).addClass("active");*/
